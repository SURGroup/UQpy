...
sphinx_gallery_conf = {
    "examples_dirs": [
        ...
        "../code/scientific_machine_learning/bbb_trainer",
        "../code/scientific_machine_learning/deep_operator_network",
        "../code/inference/mle",
    ...
    "gallery_dirs": [
        ...
        "auto_examples/scientific_machine_learning/bbb_trainer",
        "auto_examples/scientific_machine_learning/deep_operator_network",
