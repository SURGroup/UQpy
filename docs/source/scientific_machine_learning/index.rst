...
- :class:`.Optimizer`: Parent class to all optimization algorithms. Subclass of :class:`torch.optim.Optimizer`

This package focuses on supervised machine learning,
specifically on the architecture and training of Neural Networks.
