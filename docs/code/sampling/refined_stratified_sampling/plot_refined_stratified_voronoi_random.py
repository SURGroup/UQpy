...
#%% md
#
# Using UQpy RSS class to expand samples generated by STS class. In this example, two new samples are generated inside
# cells with maximum weight associated with it.
...
#%% md
#
# The figure shows the voronoi tesselation of initial samples and samples generated using RSS class. The RSS class
...
#%% md
#
# Further, RSS class is used to adaptively increase the sample size. In this example, samples are randomly added in
# cell with maximum weights associated with it and new sample generated using Simplex class.
