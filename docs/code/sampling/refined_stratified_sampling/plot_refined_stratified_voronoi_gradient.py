...
# library for plots, but also need to import the STS, RSS and Krig class from UQpy.
...
#%% md
#
# Scikit-learn Gaussian Process Regrssor is used to generated a surrogate model using STS samples and function value at
...
#%% md
#
# This figure shows the surrogate model generated using Krig class based on initial samples. Note that, user don't have
# to fit the surrogate model before executing RSS class, it is done here to show the 3-D plot.
...
#%% md
#
# Using UQpy RSS class to expand samples generated by STS class. In this example, meta specifies the method used to
# estimate the gradient and Voronoi cells are used for stratification. Krig class is used with 'Gaussian' correlation
# model.
