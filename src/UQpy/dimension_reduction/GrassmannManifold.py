    ...
    **Methods:**
    ...
    def gradient_descent(data_points, distance_fun, kwargs):
        ...
        * **mean_element** (`list`)
        ...
        _gamma = []
        if acc:
            _gamma = GrassmannManifold.log_map(points_grassmann=data_points, ref=np.asarray(mean_element))
    ...
    def frechet_variance(point_grassmann, points_grassmann, distance_fun):
        ...
        * **frechet_var** (`list`)
        ...
        accum = 0
        for i in range(nargs):
            distances = GrassmannManifold.__estimate_distance([point_grassmann, points_grassmann[i]], p_dim, distance_fun)
            accum += distances[0] ** 2
