...
class MarkovChainMonteCarlo:
    ...
    * **pdf_target** ((`list` of) callables):
        ...
        which are the point(s) at which to evaluate the pdf. Within markov_chain the `pdf_target` is evaluated as:
        ...
        are provided to markov_chain via its `args_target` input.
    ...
    * **acceptance_rate** (`list`)
        Acceptance ratio of the markov_chain chains, computed separately for each chain.
    ...
    **Methods:**
    ...
    def _preprocess_seed(seed, dimensions, chains_number):
        ...
        * seed (ndarray): seed for markov_chain
