...
class DREAM(MCMC):
    ...
    def __init__(
        ...
        :param c_star: Differential evolution parameter, should be small compared to width of target. Default: 1e-6
        :param crossover_probabilities_number: Number of crossover probabilities. Default: 3
        :param gamma_probability: Prob(gamma=1). Default: 0.2
        :param crossover_adaptation: (iter_max, rate) governs adaptation of crossover probabilities (adapts every rate
         iterations if iter<iter_max). Default: (-1, 1), i.e., no adaptation
        :param check_chains: (iter_max, rate) governs discarding of outlier chains (discard every rate iterations if
