...
x = STS(dimension=2, pdf_type=['gamma_cdf', 'Gamma'], pdf_params=[[2, 1, 3], [2, 1, 3]],
...
y = SROM(samples=x.samples, pdf_type=['gamma_cdf', 'gamma_cdf'], moments=[[6., 6.], [54., 54.]], properties=[True, True, True, False],
