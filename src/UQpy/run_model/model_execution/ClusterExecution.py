...
try:
    ...
    for i in range(len(samples)):
        ...
        model._create_input_files(
            file_name=model.input_template,
            num=i + n_existing_simulations,
            text=new_text,
    ...
    os.system(
        f"{cluster_script} {cores_per_task} {n_new_simulations} {n_existing_simulations}"
    )
