...
class BayesianConv3d(NormalBayesianLayer):
    ...
    def __init__(
        ...
        where :math:`D_\text{out} = \left\lfloor \frac{D_\text{in} + 2 \times \text{padding[0]} - \text{dilation[0]} \times (\text{kernel_size[0] - 1}) - 1}{\text{stride[0]}} + 1\right\rfloor`

        :math:`H_\text{out} = \left\lfloor \frac{H_\text{in} + 2 \times \text{padding[0]} - \text{dilation[0]} \times (\text{kernel_size[0] - 1}) - 1}{\text{stride[0]}} + 1\right\rfloor`
