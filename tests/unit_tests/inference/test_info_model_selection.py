...
def test_aic():
    ...
    m0 = DistributionModel(
        distributions=Gamma(a=None, loc=None, scale=None), n_parameters=3, name="gamma"
    )
    m1 = DistributionModel(
        distributions=Exponential(loc=None, scale=None),
        n_parameters=2,
        name="exponential",
    )
    m2 = DistributionModel(
        distributions=ChiSquare(df=None, loc=None, scale=None),
        n_parameters=3,
        name="chi-square",
    )
    ...
    selector = InformationModelSelection(
        parameter_estimators=[mle1, mle2, mle3],
        criterion=AIC(),
        n_optimizations=[5] * 3,
    )
