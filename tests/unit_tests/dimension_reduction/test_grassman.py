...
from UQpy.dimension_reduction.grassmann_manifold.GrassmannInterpolation import (
...
def test_parsimonious():
    ...
    np.testing.assert_allclose(dmaps_object.parsimonious_indices[0], 1, rtol=1e-9)
    np.testing.assert_allclose(dmaps_object.parsimonious_indices[1], 5, rtol=1e-9)
