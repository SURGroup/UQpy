...
def test_akmcs_weighted_u():
    ...
    np.testing.assert_allclose(a.samples[23, 0], -0.48297825309989356)
    np.testing.assert_allclose(a.samples[20, 1], 0.39006110248010434)
...
def test_akmcs_u():
    ...
    np.testing.assert_allclose(a.samples[23, 0], -3.781937137406927)
    np.testing.assert_allclose(a.samples[20, 1], 0.17610325620498946)
...
def test_akmcs_expected_feasibility():
    ...
    np.testing.assert_allclose(a.samples[23, 0], 5.423754197908594)
    np.testing.assert_allclose(a.samples[20, 1], 2.0355505295053384)
...
def test_akmcs_expected_improvement():
    ...
    np.testing.assert_allclose(a.samples[21, 0], 6.878734574049913)
    np.testing.assert_allclose(a.samples[20, 1], -6.3410533857909215)
...
def test_akmcs_expected_improvement_global_fit():
    ...
    np.testing.assert_allclose(a.samples[23, 0], -10.24267076486663)
    np.testing.assert_allclose(a.samples[20, 1], -11.419510366469687)
...
def test_akmcs_samples_error():
    ...
    with pytest.raises(NotImplementedError):
        a = AdaptiveKriging(
            distributions=[Normal(loc=0.0, scale=4.0)] * 3,
            runmodel_object=rmodel,
            surrogate=gpr,
            learning_nsamples=10**3,
            n_add=1,
